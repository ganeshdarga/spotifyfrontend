  ...
  return (
    ...
    <div className='w-full flex justify-between items-center font-semibold'>
        ...
        <div className='flex items-center gap-4'>
            <p className='bg-white text-black px-4 text-[15px] py-1 rounded-2xl hidden md:block cursor-pointer'>Explore Permimum</p>
            <p className='bg-black py-1 px-3 rounded-2xl text-[15px] cursor-pointer'>Install App</p>
            {/* <img className='bg-black rounded-full flex items-center justify-center cursor-pointer w-7' src={assets.bell_icon}></img> */}
